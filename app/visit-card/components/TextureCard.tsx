...
import style from './TextureCard.module.scss'

const TextureCard = () => {
  return (
    <div className={style.wrapper}>
      <div className={style.vligner}>
        <div className={style.card}>
            ...
            >
              <defs>
                <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                  <stop stop-color="#c33c33" offset="0%" />
                  <stop stop-color="#6b211c" offset="100%" />
                </linearGradient>
              </defs>
              <path
          ...
          <div className={style.cardContainer}>
            <div
              className={`${style.eight}  outline-dashed -outline-offset-4 outline-white `}
            >
              <Image
                fill
                alt="sd"
