...
const ScrollHighlighter = () => {
  ...
  useEffect(() => {
    ...
    // Intersection Observer for marks if CSS animation-timeline is not supported
    if (!CSS.supports('animation-timeline: view()')) {
      ...
      return () => marks.forEach((m) => observer.unobserve(m))
    }
  }, [isDark])
      ...
      <main>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Clone one of our Next.js example repos to your favorite git
              provider and deploy it on Vercel with the button below:
            </li>
        ...
        <section>
          ...
          <p>
            ...
            <mark
              data-author="AB"
              style={
                { '--hue': '280' } as React.CSSProperties & { '--hue': string }
              }
            >
              <span>
          ...
          <p>
            ...
            storage. Instead, these files are located in the Next.js cache
            (which expires).
          </p>
          <p>
            <mark
              data-author="GR"
              style={
                { '--hue': '30' } as React.CSSProperties & { '--hue': string }
              }
            >
              <span>
        ...
        <section>
          ...
          <p>
            Server-Side Rendering (SSR) allows you to render pages dynamically
            on the server. This is useful for pages where the rendered data
            needs to be unique on every request. For example, checking
            authentication or looking at the location of an incoming request.
          </p>
          <p>
            On Vercel,
            <mark
              data-author="LR"
              style={
                { '--hue': '220' } as React.CSSProperties & { '--hue': string }
              }
            >
              <span>
          ...
          <ul>
            ...
            <li>
              Has zero-configuration support for Cache-Control headers,
        ...
        <section>
          ...
          <p>
            Image Optimization helps you achieve faster page loads by reducing
            the size of images and using modern image formats.
          </p>
          <p>
            ...
            <mark
              data-author="MN"
              style={
                { '--hue': '140' } as React.CSSProperties & { '--hue': string }
              }
            >
          ...
          <p>
            When self-hosting, Image Optimization uses the default Next.js
            server for optimization. This server manages the rendering of pages
          ...
          <p>
            ...
            <mark
              data-author="IR"
              style={
                { '--hue': '10' } as React.CSSProperties & { '--hue': string }
              }
            >
              <span>
                import the next/image component into the component you&#39;d
          ...
          <ul>
            ...
            <li>
              <mark
                data-author="SH"
                style={
                  { '--hue': '190' } as React.CSSProperties & {
                    '--hue': string
                  }
                }
              >
