...
import Gallery from '@/components/(vignette-effect)/Gallery'
import Description from '@/components/(vignette-effect)/Description'
// import Description from '../components/description'

const projects = [
  {
    name: 'Dyal Thak',
    //Its corresponding name path into public/images
    handle: 'dyal_thak',
  },
  {
